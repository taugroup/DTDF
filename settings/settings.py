...
SECRET_KEY = 'django-insecure-acc3ppro3!whvlk%yb$xnb7!u^4crt34-*s#tanhdwx#vur#p^'
...
EMAIL_HOST_USER = 'sctenifold@gmail.com'
EMAIL_HOST_PASSWORD = 'tamusctenifold'  # past the key or password app here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
PORTAL_MAX_NUMBER_PROJECTS = 4
PORTAL_MAX_NUMBER_FILES_PER_PROJECT = 2000